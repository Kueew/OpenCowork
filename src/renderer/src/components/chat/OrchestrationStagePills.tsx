      ...
      {stages.map((stage, index) => (
        <div
          ...
          className={cn(
            ...
            stage.status === 'completed' && 'border-emerald-500/25 bg-emerald-500/10 text-emerald-400',
            stage.status === 'active' && 'border-cyan-500/30 bg-cyan-500/12 text-cyan-300',
            stage.status === 'pending' && 'border-border/60 bg-background/70 text-muted-foreground/70',
